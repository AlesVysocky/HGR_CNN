...
def process_img(sample_id, files_len, subset_path, subset_names_full):
    ...
    try:
        ...
        combined_mask = rgb_mask_l + rgb_mask_r
        ...
        cv2.imwrite(os.path.join(dataset_dir, "mask_formatted", subset_names_full+".png"), combined_mask)
        cv2.imwrite(os.path.join(dataset_dir, "depth_formatted", subset_names_full+".png"), depth_byte)
