...
config = c.Configuration(version_name = "autoencoder", debug_mode=False, latest_model_name="fcn_model_obstacles.h5")
...
if __name__ == "__main__":
    ...
    #sys.argv = [sys.argv[0], predict_command, os.path.join(c.current_dir_path, "testdata", "test1.jpg")]
